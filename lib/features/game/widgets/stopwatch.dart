...
class _StopwatchState extends State<Stopwatch> with TickerProviderStateMixin {
  ...
  String parse(Duration duration, {String delimiter = ':'}) {
    ...
    // Auto-adjust format if no specific format is provided
    if (widget.textFormat == null) {
    ...
    bool hasDays = format.contains('D');
    bool hasHours = format.contains('H');

    String days = duration.inDays.toString();
    String hours = (hasDays ? duration.inHours % 24 : duration.inHours).toString();
    String minutes = (hasHours ? duration.inMinutes % 60 : duration.inMinutes).toString();
    String seconds = (duration.inSeconds % 60).toString();

    String daysPadded = days.padLeft(2, '0');
...
class StopwatchManager {
  ...
  bool isRunning() {
    ...
    return _status == StopwatchStatus.running;
  }
  ...
  bool isCompleted() {
    ...
    return _status == StopwatchStatus.completed;
  }
  ...
  bool isPaused() {
    ...
    return _status == StopwatchStatus.paused;
  }
  ...
  bool isStopped() {
    ...
    return _status == StopwatchStatus.stopped;
  }
