...
class SettingsManager extends ChangeNotifier {
  ...
  /// Sets whether haptic feedback is enabled to [value].
  ...
  void loadFromMap(Map<String, dynamic> map) {
    ...
    _candidateUpdate = map['candidateUpdate'] ?? _candidateUpdate;
    ...
    _enableHaptics = map['enableHaptics'] ?? _enableHaptics;
    notifyListeners();
  }
