...
import 'package:sudoku/game/sudoku_grid.dart';
...
class SudokuManager {
  ...
  void generateGame({GenerationMode mode = GenerationMode.symmetric, int? seed}) {
    // Create a brand new grid.
    _grid = SudokuGrid.generateGame(gridSize: _gridSize, difficulty: _difficulty, mode: mode, seed: seed);
